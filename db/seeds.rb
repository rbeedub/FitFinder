...
User.create(name: "Chad Johnson", email: "sexychad@sports.com", age: 25, username: "chadtastic", password: "Password123!", bio: "Former D1 Athlete, BALL IS LIFE, just looking for some local lads to toss the old pig skin with.", location_zip: 06831, location_name: "Greenwich", photo: "./images/4.svg")
...
User.create(name: "Isis Gaston", email: "icespice@capitolrecords.com", age: 23, username: "icespice", password: "Password123!", bio: "Tryna find a gangsta boo to work out wit! NO MUNCHES ALLOWED!", location_zip: 10474, location_name: "New York", photo: "./images/7.svg")
User.create(name: "Dwight Schrute", email: "dschrute@dundermifflin.com", age: 43, username: "beetluvr", password: "Password123!", bio: "Beets. Bears. Battlestar Galactica... Bench press?", location_zip: 18503, location_name: "Scranton, PA", photo: "./images/8.svg")
User.create(name: "Caleigh Steill", email: "caleighsteill@gmail.com", age: 23, username: "cmoneysbigmoves", password: "Password123!", bio: "Cat-mom, yogi, city-dweller, nature-lover <3", location_zip: 10012, location_name: "New York", photo: "./images/8.svg")
User.create(name: "Rebecca Wollard", email: "rebeccawollard@gmail.com", age: 39, username: "rbeedub", password: "Password123!", bio: "Dog-mom! CA --> CO! Let's be fitness friends", location_zip: 80014, location_name: "Denver", photo: "./images/9.svg")
User.create(name: "Matt Ishida", email: "mattishida@gmail.com", age: 30, username: "mattishida", password: "Password123!", bio: "Looking for fellow islanders to get active with!", location_zip: 96813, location_name: "Honolulu", photo: "./images/10.svg")
User.create(name: "Jensen Miers", email: "jmiers@gmail.com", age: 26, username: "jensenorita", password: "Password123!", bio: "Basketball enthusiast. Angeleno. Let's shoot some hoops together.", location_zip: 90045, location_name: "Los Angeles", photo: "./images/11.svg")
User.create(name: "Walker Le", email: "wlee@flatearthsociety.com", age: 30, username: "earth_is_flat", password: "Password123!", bio: "Founder of the Flat Earth Society, looking for a running partner, but preferably flat terrain only", location_zip: 80014, location_name: "Denver", photo: "./images/12.svg")
User.create(name: "Ben Murchie", email: "benmurchie@gmail.com", age: 27, username: "beanswtf", password: "Password123!", bio: "Self-proclaimed hermit who is trying to get out more.", location_zip: 98901, location_name: "Yakima", photo: "./images/13.svg")
User.create(name: "Austin Schaffer", email: "aschaffer@gmail.com", age: 28, username: "itsyaboi", password: "Password123!", bio: "Racer. Looking for some bois to go down to the track for a couple laps, ya heard!", location_zip: 35005, location_name: "Birmingham", photo: "./images/14.svg")
User.create(name: "Ryan Horn", email: "rhorn@gmail.com", age: 39, username: "rhorn", password: "Password123!", bio: "Looking for a hiking buddy! Proud Coloradoan.", location_zip: 80014, location_name: "Denver", photo: "./images/15.svg")
User.create(name: "Jaz Singh", email: "jsingh@gmail.com", age: 23, username: "smooth_jaz", password: "Password123!", bio: "Personal trainer looking to find other trainers to collaborate with and learn from!", location_zip: 95660, location_name: "Sacramento", photo: "./images/16.svg")
User.create(name: "Surapat Mekvanich", email: "surapatmek@gmail.com", age: 26, username: "surmek", password: "Password123!", bio: "Chill guy looking for other chill people to chill with and maybe do some working out.", location_zip: 98901, location_name: "Yakima", photo: "./images/17.svg")
User.create(name: "Colm Traci", email: "ctraci@gmail.com", age: 21, username: "keep_colm", password: "Password123!", bio: "Based in SF. Need someone to take long uphill walks with.", location_zip: 94106, location_name: "San Francisco", photo: "./images/18.svg")
User.create(name: "Lantz Warrick", email: "ctraci@flatironschool.com", age: 50, username: "betalantz", password: "Password123!", bio: "Seattlite. Programmer. Teacher. Overall awesome guy.", location_zip: 94106, location_name: "Seattle", photo: "./images/19.svg")
User.create(name: "Chris Santander", email: "chris@elevow.com", age: 25, username: "chrees", password: "Password123!", bio: "Bolivia Born. Cat-Dad. Let's be gym bros.", location_zip: 98101, location_name: "Seattle", photo: "./images/20.svg")
User.create(name: "Sam Chappell", email: "schappel@gmail.com", age: 26, username: "packdaddy", password: "Password123!", bio: "Dog-Mommy! Rock climber seeking a fun, group of fellow climbers. Must be a dog lover. And a little sassy. And sarcastic.", location_zip: 98045, location_name: "Bend", photo: "./images/21.svg")
User.create(name: "Javonn Williams", email: "jwilliams@gmail.com", age: 26, username: "gymgod73", password: "Password123!", bio: "Body builder. Football lover. Baby oil consumer.", location_zip: 94501, location_name: "Oakland", photo: "./images/22.svg")
User.create(name: "Topher Ludlow", email: "topher@gmail.com", age: 26, username: "tophdoggy", password: "Password123!", bio: "Water-sign. Mustache-haver. Metal core enjoyer. If you are also one or more of those things then we can workout together.", location_zip: 95631, location_name: "Foresthill", photo: "./images/23.svg")
User.create(name: "Liam Namba", email: "lermnamba@gmail.com", age: 25, username: "lerm_the_werm", password: "Password123!", bio: "Hawaiian living in LA. Currently training for a marathon and could use some running buddies. Preferably, non-smokers so I'm not tempted. Need my lungs to be in the best shape possible.", location_zip: 90045, location_name: "Los Angeles", photo: "./images/24.svg")
User.create(name: "Amelia Jay", email: "meels@gmail.com", age: 25, username: "meelzzz", password: "Password123!", bio: "Seattle --> LA. Love a long walk on the beach. Need some girlies to go on hot girl walks with!!!", location_zip: 90283, location_name: "Playa Del Rey", photo: "./images/24.svg")
User.create(name: "Anita Mann", email: "anitamann@gmail.com", age: 38, username: "anitamann", password: "Password123!", bio: "Anita partner to play doubles with!", location_zip: 10017, location_name: "New York", photo: "./images/25.svg")
User.create(name: "Sofia Shelton", email: "sofiashelton@gmail.com", age: 19, username: "fekes", password: "Password123!", bio: "Model. Based in NYC. Looking for some girlies to go to pilates with.", location_zip: 10012, location_name: "New York", photo: "./images/26.svg")
User.create(name: "Arthur Jones", email: "ajones@jonesbbqnfootmassage.com", age: 48, username: "bbqking", password: "Password123!", bio: "Owner of Jones BBQ and Foot Massage! Chicagoan. Want to find some fellas that love fitness, BBQ, and foot massages as much as I do", location_zip: 60007, location_name: "Chicago", photo: "./images/27.svg")
User.create(name: "Creed Bratton", email: "creed@dundermifflin.com", age: 60, username: "assassins_creed", password: "Password123!", bio: "Down for anything as long as I don't go back to jail", location_zip: 18503, location_name: "Scranton", photo: "./images/28.svg")
User.create(name: "Simon Saize", email: "simon@gmail.com", age: 42, username: "simonsays", password: "Password123!", bio: "Competitive cup-stacker looking to diversify my fitness portfolio.", location_zip: 10017, location_name: "New York", photo: "./images/29.svg")
...
participants:Faker::Number.between(from: 1, to: 10), host_id: User.all.sample.id, 
activity: "badminton")
