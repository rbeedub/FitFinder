...
# end
puts "Seeding users..."
User.create(name: "Michael Scott", email: "mscott@dundermifflin.com", age: 45, username: "chaotic_evil", password: "Password123!", bio: "World's Greatest Boss, Marathon Runner - Rabies Curer", location_zip: 18503, location_name: "Scranton", photo: "https://www.coopers-seafood.com/wp-content/uploads/2019/03/rabies-run.jpg")
...
User.create(name: "Chris Santander", email: "chris@elevow.com", age: 25, username: "chrees", password: "Password123!", bio: "Bolivian. Cat-Dad. Let's be gym bros.", location_zip: 98101, location_name: "Seattle", photo: "/images/22.svg")
...
User.create(name: "Anita Mann", email: "anitamann@gmail.com", age: 38, username: "anitamann", password: "Password123!", bio: "Anita partner to play doubles with!", location_zip: 10017, location_name: "New York", photo: "/images/31.svg")
User.create(name: "Toby Jones", email: "tjones@jonesbbqnfootmassage.com", age: 48, username: "bbqking", password: "Password123!", bio: "Owner of Jones BBQ and Foot Massage! Chicagoan. Want to find some fellas that love fitness, BBQ, and foot massages as much as I do", location_zip: 60007, location_name: "Chicago", photo: "/images/28.svg")
...
participants:Faker::Number.between(from: 1, to: 10), host_id: User.all.sample.id, activity: Activity.find_by(activity: "badminton"), image: "https://www.stocksbridgeclc.co.uk/wp-content/uploads/2016/08/Badminton-Slider2.jpg" )
