...
User.create(name: "Dwight Schrute", email: "dschrute@dundermifflin.com", age: 43, username: "beetluvr", password: "Password123!", bio: "Beets. Bears. Battlestar Galactica... Bench press?", location_zip: 18503, location_name: "Scranton, PA", photo: "./images/9.svg")
...
participants:Faker::Number.between(from: 1, to: 10), host_id: User.all.sample.id, activity_id: 14)
